...
<svg xmlns="http://www.w3.org/2000/svg" width="520" height="240" viewBox="0 0 520 240">
  ...
  <text x="82" y="66" fill="#1f3b57" font-family="Arial, sans-serif" font-size="24">Editable Image</text>
</svg>
`)}`

const readonlyLatex = String.raw`这是只读渲染示例：$a^2 + b^2 = c^2$，括号题：\paren，填空题：\blank。
\begin{center}
\includegraphics[width=4.2cm]{${demoImageSrc}}
\end{center}
...
\\includegraphics[width=5cm]{\${imageSrc}}
